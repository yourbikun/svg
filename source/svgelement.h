...
public:
    ...
    SVGMarkerElement* getMarker(const std::string& id) const;
    SVGClipPathElement* getClipper(const std::string& id) const;
    SVGMaskElement* getMasker(const std::string& id) const;
    SVGPaintElement* getPainter(const std::string& id) const;
